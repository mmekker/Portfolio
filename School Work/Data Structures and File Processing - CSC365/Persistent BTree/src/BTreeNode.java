public class BTreeNode {
	...
	public boolean splitRoot(String key)
	{
		...
		BTreeNode l = new BTreeNode(order, c);
		BTreeNode r = new BTreeNode(order, c);
	...
	public void splitFullNode(BTreeNode fNode)
	{
		...
		BTreeNode right = new BTreeNode(order, c);//make new right node
	...
	public void merge(int left, int right)
	{
		...
		BTreeNode n = new BTreeNode(order, c);
		for(int x = 0; x < (order/2)-1; x++)
		{
