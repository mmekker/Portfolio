...
/**
 * SideWalls are similar to EndWalls. Their purpose is to keep cars and balls
 * inside to field.
 * 
 * @author mmekker
 *
...
public class SideWall {
	...
	public static final float WALL_WIDTH = (Gdx.graphics.getHeight()*0.16667f);
	public static final float WALL_HEIGHT = Gdx.graphics.getHeight();

	public SideWall(World world, int x, int y) {
